...
func main() {
    ...
    utils.ContextualMain(mainWithArgs, module.NewLoggerFromArgs("testmovementsensor"))
}
        ...
        Components: []resource.Config{
            {
                ...
                Model: custommovementsensor.Model,
                Attributes: rdkutils.AttributeMap{
                    "one": arg_2_converted,
                    "two": os.Args[3],
                },
                ConvertedAttributes: &custommovementsensor.Config{
